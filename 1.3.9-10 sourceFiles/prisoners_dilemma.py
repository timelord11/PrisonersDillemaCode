...
import example0, example1, example3
...
modules = [example0, example1, example3, example4, example5, example6, example7,
...
modules_for_game = [team8, example0, example1, example3, example4, example5, example5]
